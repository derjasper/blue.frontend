...
*blue.frontend* is a SASS and JavaScript/jQuery library to design websites. It
provides basic mixins to define the website's layout and behaviour. All features
are responsive and respond instantly to new screen sizes. Also, blue.frontend does
...
possible with CSS**, such as sticky elements or trigger. The blue.frontend's core
