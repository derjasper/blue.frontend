...
.. js:function:: bluejs.customrules.addProperty(mq,sel,rule,options)
...
.. js:function:: bluejs.customrules.addProperties(tree)

   A tree generated by the CSS Parser. All rules will be merged to ``ruleslist``.

   :param object tree: The tree.

.. js:function:: bluejs.customrules.enableProperty(elm,mq,sel,index)
